...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-2">Modifier une entreprise</h1>
    <p class="text-gray-600">Mettre à jour les informations de l'entreprise</p>
</div>

<div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="p-6">
        <form action="{{ route('societes.update', $societe->soc_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="md:col-span-2">
                    ...
                    <input 
                        ...
                        name="soc_nom" 
                        required
                        value="{{ old('soc_nom', $societe->soc_nom) }}"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_num" 
                        name="soc_num"
                        value="{{ old('soc_num', $societe->soc_num) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_commune" 
                        name="soc_commune"
                        value="{{ old('soc_commune', $societe->soc_commune) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Paris"
                    >
                    @error('soc_commune')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_cp" 
                        name="soc_cp"
                        value="{{ old('soc_cp', $societe->soc_cp) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="75000"
                    >
                    @error('soc_cp')
                ...
                <div>
                    ...
                    >
                        ...
                        @foreach($pays as $p)
                            <option value="{{ $p->pays_id }}" {{ old('soc_pays_id', $societe->soc_pays_id) == $p->pays_id ? 'selected' : '' }}>
                                {{ $p->pays_nom }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_tel" 
                        name="soc_tel"
                        value="{{ old('soc_tel', $societe->soc_tel) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_fax" 
                        name="soc_fax"
                        value="{{ old('soc_fax', $societe->soc_fax) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_mel" 
                        name="soc_mel"
                        value="{{ old('soc_mel', $societe->soc_mel) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_web" 
                        name="soc_web"
                        value="{{ old('soc_web', $societe->soc_web) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="md:col-span-2">
                    ...
                    <input 
                        ...
                        id="soc_adresse" 
                        name="soc_adresse"
                        value="{{ old('soc_adresse', $societe->soc_adresse) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="md:col-span-2">
                    ...
                    <input 
                        ...
                        id="soc_adressebis" 
                        name="soc_adressebis"
                        value="{{ old('soc_adressebis', $societe->soc_adressebis) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_bp" 
                        name="soc_bp"
                        value="{{ old('soc_bp', $societe->soc_bp) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="BP 123"
                    >
                    @error('soc_bp')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_siret" 
                        name="soc_siret"
                        value="{{ old('soc_siret', $societe->soc_siret) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_tva" 
                        name="soc_tva"
                        value="{{ old('soc_tva', $societe->soc_tva) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_naf" 
                        name="soc_naf"
                        value="{{ old('soc_naf', $societe->soc_naf) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="1234A"
                    >
                    @error('soc_naf')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_iban" 
                        name="soc_iban"
                        value="{{ old('soc_iban', $societe->soc_iban) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="soc_bic" 
                        name="soc_bic"
                        value="{{ old('soc_bic', $societe->soc_bic) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div class="md:col-span-2">
                    ...
                    >{{ old('soc_obs', $societe->soc_obs) }}</textarea>
                    @error('soc_obs')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="soc_lat"
                        step="0.000001"
                        value="{{ old('soc_lat', $societe->soc_lat) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="48.8566"
                    >
                    @error('soc_lat')
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="soc_lng"
                        step="0.000001"
                        value="{{ old('soc_lng', $societe->soc_lng) }}"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="2.3522"
                    >
                    @error('soc_lng')
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="flex items-center">
                            <input 
                                ...
                                name="soc_defaut" 
                                value="1"
                                {{ old('soc_defaut', $societe->soc_defaut) ? 'checked' : '' }}
                        ...
                        <div class="flex items-center">
                            <input 
                                ...
                                name="actif" 
                                value="1"
                                {{ old('actif', $societe->actif) ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                            >
                        ...
                        <div class="flex items-center">
                            <input 
                                ...
                                name="prospect" 
                                value="1"
                                {{ old('prospect', $societe->prospect) ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                            >
