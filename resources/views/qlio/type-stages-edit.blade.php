...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <div class="flex items-center mb-6">
            ...
            <h1 class="text-3xl font-bold text-gray-800">Modifier un Type de Stage</h1>
        </div>

        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('type-stages.update', $typeStage->typsta_id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <input 
                        ...
                        value="{{ old('typsta_libelle', $typeStage->typsta_libelle) }}"
                        required
                        maxlength="100"
                    >
                ...
                <div class="mb-6">
                    ...
                    <textarea 
                        ...
                        rows="4" 
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >{{ old('typsta_obs', $typeStage->typsta_obs) }}</textarea>
                    @error('typsta_obs')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    <div class="flex items-center">
                        <input 
                            ...
                            name="actif" 
                            value="1"
                            {{ old('actif', $typeStage->actif) ? 'checked' : '' }}
