...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-2">Ajouter une nomenclature</h1>
    <p class="text-gray-600">Créer une nouvelle entrée de nomenclature</p>
</div>
        ...
        <form action="{{ route('nomenclatures.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="nomenc_cat" name="nomenc_cat" value="{{ old('nomenc_cat') }}"
                ...
                <div>
                    ...
                    <input type="number" id="ordre" name="ordre" value="{{ old('ordre') }}" min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                           placeholder="0">
                    @error('ordre')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" id="nomenc_nom" name="nomenc_nom" value="{{ old('nomenc_nom') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
                           placeholder="Libellé">
                    @error('nomenc_nom')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="text" id="nomenc_ref" name="nomenc_ref" value="{{ old('nomenc_ref') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
